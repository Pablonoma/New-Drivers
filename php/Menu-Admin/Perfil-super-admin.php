...
<body>
    ...
    <section id="menu">
        ...
        <div class="bottom-items">
            <a href="perfil-super-admin.php" style="color: #FDD45B;">
                <li id="mi-perfil"><i class="fa-solid fa-user" style="color: #FDD45B;"></i> Mi Perfil</li>
            </a>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response == "success") {
                            ...
                            setTimeout(function() {
                                window.location.href = 'Perfil-super-admin.php';
                            }, 2000);
                        } else {
