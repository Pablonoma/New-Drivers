...
$consulta = "SELECT nombre, correo FROM usuario WHERE id_user = '$id_user'";
...
if ($respuesta == 'rechazar') {
  ...
  $sendSmtpEmail['subject'] = 'Solicitud NewDrivers';
    ...
    <div class="centered-div">
        <div class="contenedor">
            ...
            <div style="color: #ffffff; font-family: arial, helvetica, sans-serif; font-size: 16px; line-height: 1.5; padding-bottom: 15px; padding-left: 21px; padding-top: 15px; text-align: justify;">
                <p style="margin: 0">Hola <b>' . $nombre . '</b>   Hemos evaluado minuciosamente la información y los documentos proporcionados al crear su cuenta, y lamentamos comunicarle que en este momento
                no cumple con los requisitos necesarios para ejercer como instructor en NewDrivers.</p>
            </div>
        </div>
    </div>
</body>
...
<body>
    <div class="centered-div">
        <div class="contenedor">
            ...
            <div style="color: #FDD45B; font-family: arial, helvetica, sans-serif; font-size: 16px; line-height: 1.5; padding-top: 40px;">
                <p style="margin: 0; font-size: 26px;">
                    <strong>¡Bienvenido al equipo de instructores de NewDrivers!</strong>
                </p>
            </div>
            <div style="color: #ffffff; font-family: arial, helvetica, sans-serif; font-size: 16px; line-height: 1.5; padding-bottom: 15px; padding-left: 21px; padding-top: 15px; text-align: justify;">
                <p style="margin: 0">      Nos complace informarle que ha sido aprobado para impartir clases en NewDrivers. ¡Felicidades!
                                          Esperamos que su experiencia como instructor en nuestra plataforma sea gratificante y exitosa.
                                          Estamos seguros de que aportará un valioso conocimiento y habilidades a nuestros estudiantes.
                                          ¡Bienvenido al equipo de instructores de NewDrivers!</p>
            </div>
        </div>
    </div>
</body>
