...
<head>
    ...
    <title>Menu - Adminsitrador</title>
</head>
...
<body>
    ...
    <section id="menu">
        ...
        <div class="items">
            ...
            <a href="Cambiar-Contrasena-Admin.php" style="color: #FDD45B;">
                ...
                <form class="formulario mb-5" id="formulario" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="passwordAntigua mb-3" id="grupo__password_old">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="password" name="passwordAntigua" class="formulario__input form-control bg-dark-x border-1 mb-2" placeholder="Ingresa tu contraseña antigua contraseña" id="passwordAntigua" required>
                    ...
                    <div class="formulario__grupo mb-3" id="grupo__password">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="password" name="password" class="formulario__input form-control bg-dark-x border-1 mb-2" placeholder="Ingresa tu contraseña tú nueva contraseña" id="password" required>
                            <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        </div>
                    ...
                    <div class="formulario__grupo mb-3" id="grupo__password2">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="password" name="password2" class="formulario__input form-control bg-dark-x border-1 mb-2" placeholder="Ingresa tu contraseña nuevamente" id="password2" required>
                            <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response == "success") {
                            ...
                            setTimeout(function() {
                                window.location.href = 'Cambiar-Contrasena-Admin.php';
                            }, 2000);
                            ...
                            Swal.fire({
                                title: 'Error con la nueva contraseña',
                                text: 'La nueva contraseña no puede ser la misma que la actual. Por favor, intenta nuevamente.',
                                icon: 'error',
                                confirmButtonText: 'Volver',
                                confirmButtonColor: '#356dce'
                            });
