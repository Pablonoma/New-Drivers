...
<body>
    ...
    <section id="menu">
        ...
        <div class="items">
            ...
            <a href="Reagendar-Clases.php" style="color: #FDD45B;">
                <li><i class="fa-solid fa-repeat" style="color: #FDD45B;"></i>Reagendar Clases</li>
            </a>
            ...
            <table id="example" class="display table-hover bg-dark" style="width:100%; color: #ffff">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Motivo de la cancelación</th>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                             ...
                             $motivo = $usuario['observacion_profe'];
                            ...
                            <td class="text-center">
                                <?php if ($usuario['estado_clase'] == 'Cancelada') { ?>
                                    <button type="button" style="margin-right: 5px !important;" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#cancelarClaseTeoricaReagendar<?php echo $id_clase; ?>">
                                        <i class="fa-solid fa-repeat"></i></button>
                                <?php } ?>
                            </td>
                            <?php include('modal/Reagendar-Clase.php'); ?>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($usuario['estado_clase'] == 'Cancelada') { ?>
                                    <button type="button" style="margin-right: 5px !important;" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#cancelarClasePracticaReagendar<?php echo $id_clase; ?>">
                                        <i class="fa-solid fa-repeat"></i></button>
                                <?php } ?>
                            </td>
                            <?php include('modal/Reagendar-Clase.php'); ?>
    ...
    if (isset($_POST['reagendarTeorica'])) {
        if (!empty($_POST['id_clase'])) {
            ...
            $resultado = $dao->reagendarClaseTeorica($id_clase, $comienzo, $termino);
            if ($resultado == true) {
                ...
                $sendSmtpEmail['subject'] = 'Se ha reagendado su clase teórica.';
                                                ...
                                                <div class="contenedor">
                                                    ...
                                                    <div style="color: #FDD45B; font-family: arial, helvetica, sans-serif; font-size: 16px; line-height: 1.5; padding-top: 40px;">
                                                        <p style="margin: 0; font-size: 26px;">
                                                            <strong>Clase teórica reagendada</strong>
                                                        </p>
                                                    </div>
                                                    <div style="color: #ffffff; font-family: arial, helvetica, sans-serif; font-size: 16px; line-height: 1.5; padding-bottom: 15px; padding-left: 21px; padding-top: 15px; text-align: justify;">
                                                        <p style="margin: 0">Estimado(a) <b>' . $nombreAlumno . '</b><br>
                                                                                    Nos complace comunicar que hemos logrado reagendar la clase que su instructor canceló anteriormente debido a ' . $motivo . '. La clase fue reagendada para el día <b>'. $dia_formateada .'</b> a las <b>'. $hora_formateada .'</b> horas.
                                                                                    <br><br>
                                                                                    Lamentamos profundamente cualquier inconveniente que esta cancelación pueda haber causado.
                                                                                    Hemos trabajado para reagendar la clase lo antes posible y asegurar que pueda continuar con su formación sin mayores contratiempos.<br><br>

                                                                                    Le recomendamos ingresar a New Drivers para ver todos los detalles correspondientes a la nueva programación.
                                                                                    Si tiene alguna pregunta o necesita más información, no dude en ponerse en contacto con nosotros.<br><br>

                                                                                    Agradecemos su comprensión y paciencia en esta situación.<br><br>
                ...
                try {
                    ...
                    text: 'La clase fue reagendada correctamente',
                    icon: 'success',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'Reagendar-Clases.php';
                    }
                    });
                </script>";
                } catch (Exception $e) {
    ...
    if (isset($_POST['reagendarPractica'])) {
        if (!empty($_POST['id_clase'])) {
            ...
            $resultado = $dao->reagendarClasePractica($id_clase, $comienzo, $termino);
            if ($resultado == true) {
                ...
                // Configuración del asunto del correo electrónico
                $sendSmtpEmail['subject'] = 'Se ha reagendado su clase práctica';
                                                ...
                                                <body>
                                                    <div class="centered-div">
                                                        <div class="contenedor">
                                                            ...
                                                            <div style="color: #FDD45B; font-family: arial, helvetica, sans-serif; font-size: 16px; line-height: 1.5; padding-top: 40px;">
                                                                <p style="margin: 0; font-size: 26px;">
                                                                    <strong>Clase práctica reagendada</strong>
                                                                </p>
                                                            </div>
                                                            <div style="color: #ffffff; font-family: arial, helvetica, sans-serif; font-size: 16px; line-height: 1.5; padding-bottom: 15px; padding-left: 21px; padding-top: 15px; text-align: justify;">
                                                                <p style="margin: 0">Estimado(a) <b>' . $nombreAlumno . '</b><br>
    ...
    <script src="../../Js/Reagendar-Clases.js"></script>
    <script src="../../Js/Reagendar-Clases2.js"></script>
