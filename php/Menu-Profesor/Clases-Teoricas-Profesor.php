...
<body>
    ...
    <section id="menu">
        ...
        <div class="items">
            ...
            <a href="Clases-Teoricas-Profesor.php" style="color: #FDD45B;">
                <li><i class="fa-solid fa-book-open" style="color: #FDD45B;"></i>Clases Teoricas</li>
            </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: {
                    url: 'calendarios-profesor/Controller-Calendario-Teorica.php',
                    method: 'GET',
