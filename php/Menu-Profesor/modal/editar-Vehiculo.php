...
<div class="modal fade" id="editarVehiculo<?php echo $vehiculo['id_auto']; ?>" tabindex="-1" data-bs-backdrop="static" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="position: relative; z-index: 3;">
        <div class="modal-content">
            ...
            <div class="editar p-4">
                ...
                <input type="hidden" name="id_auto" value="<?php echo $vehiculo['id_auto']; ?>">
                    <div class="mb-3">
                        <label for="exampleInputModelo" class="form-label font-weight-bold">Modelo del vehículo</label>
                        <input type="text" name="modelo" value="<?php echo $vehiculo['modelo'] ?>" class="form-control bg-dark-x border-2" placeholder="Fiat 500, Honda Civic, Kia Morning, etc " aria-describedby="emailHelp" required>
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputAño" class="form-label font-weight-bold">Año del vehículo</label>
                        <input type="number" name="ano" value="<?php echo $vehiculo['ano'] ?>" class="form-control bg-dark-x border-2 mb-2" placeholder="Ingresa el año del vehículo" required oninput="if(this.value.length > 4) this.value = this.value.slice(0,4);">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPersonas" class="form-label font-weight-bold">Cantidad de personas</label>
                        <input type="number" name="personas" value="<?php echo $vehiculo['personas'] ?>" class="form-control bg-dark-x border-2 mb-2" placeholder="Ingresa la cantidad de personas de tu vehículo" required oninput="if(this.value.length > 1) this.value = this.value.slice(0,1);">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="patente" class="form-control bg-dark-x border-2" value="<?php echo $vehiculo['patente'] ?>" placeholder="FF-FF-FF" aria-describedby="emailHelp" required>
                    </div>

                    <button type="submit" name="editar" class="btn btn-warning w-100">Guardar Cambios</button>
                </form>
            </div>
