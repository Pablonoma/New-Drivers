        ...
        <div class="row g-0">
            ...
            <div class="col-lg-5 d-flex flex-column align-items-end min-vh-100">
                ...
                <div class="px-lg-5 py-lg-4 p-4 w-100 align-self-center">
                    ...
                    <form class="formulario mb-5" id="formulario" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label font-weight-bold">Ubicación</label>
                        ...
                        <div class="formulario__grupo mb-3" id="grupo__correo">
                            ...
                            <p class="formulario__input-error">El correo solo puede contener letras, números, puntos, guiones y guiones bajos.</p>
                            </div>
                        ...
                        <button type="submit" name="registrar" class="btn btn-primary w-100 p-2">Registrarme</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#formulario').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'php-registro/ajax_registrar_usuario.php',
                    data: formData,
