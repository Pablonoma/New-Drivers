...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = $funciones->registrarProfesor($nombre, $numero, $fechaN, $correo, $password, $password2, $experiencia,
     $archivos["archivo1"], $archivos["archivo2"], $archivos["archivo3"], $archivos["archivo4"], $archivos["archivo5"], $descripcion, $ubicacion);
