...
$var = $_GET['id_profesor'];
$varSolicitud = $_GET['id_solicitud'];
...
<body>
    ...
    <section id="interface">
        ...
        <div class="values">
            <!-- Body Inicio  -->
            <br><br><br>
            <h1 class="heading">Calendario de Clases Teóricas</h1><br>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" id="bod">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tituloEdit" readonly style="color: #000000;" autocomplete="off" placeholder="Ingrese un título para agendar la clase">
                        </div>
                        <div class="form-group" style="margin-top:5px;">
                            <label for="detalle">Descripción</label>
                            <textarea class="form-control" id="descripcionEdit" readonly style="color: #000000;" rows="3" placeholder="Ingrese la Descripción"></textarea>
                        </div>
                        <div class="form-group" style="margin-top:5px;">
                            <div class="row">
                                <div class="col">
                                    <label for="fechaHora">Fecha de inicio</label>
                                    <input type="datetime-local" class="form-control" readonly style="color: #000000;" id="comienzoEdit" placeholder="Ingrese la fecha y hora de inicio de la clase">
                                </div>
                                <div class="col">
                                    <label for="duracion">Fecha de termino</label>
                                    <input type="datetime-local" class="form-control" readonly style="color: #000000;" id="terminoEdit" placeholder="Ingrese la duración">
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer" id="mod_fot" style="display: flex; justify-content: end;">
                    <button type="button" class="btn btn-success" style="width: 24%;" id="eliminarEvento">Agendar</button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var id_profesor = "<?php echo $var ?>"; // Obtén el valor de la variable PHP
            var id_solicitud = "<?php echo $varSolicitud ?>"; // Obtén el valor de la variable PHP
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: {
                    url: 'Agendar-Controller/Controller_Calendario_Alumno.php?id=' + id_profesor + '&flag=agendarClaseTeorica', // Pasa la variable como parámetro GET
                    method: 'GET',
            ...
            document.getElementById('eliminarEvento').addEventListener('click', function() {
                ...
                Swal.fire({
                    title: '¿Estás seguro?',
                    text: '¿Estás seguro de agendar en este horario de clases?',
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: 'Agendar-Controller/Controller_Calendario_Alumno.php?flag=agendarClaseTeorica',
                            type: 'POST',
                            data: {
                                action: 'agendar',
                            ...
                            success: function(response) {
                                if (response == 'success') {
                                    ...
                                    Swal.fire({
                                        ...
                                        text: 'La clase ha sido agendada correctamente.',
                                        icon: 'success',
                                ...
                                } else if (response == 'maximo_12') {
                                    $('#eventoModalEdit').modal('hide');
                                    console.log(response);
                                    Swal.fire({
                                        title: 'Ya cuenta con todas sus clases teóricas agendadas',
                                        text: 'Ha alcanzado el máximo de 12 clases teóricas permitidas. Luego de completar sus clases teóricas, el profesor habilitará el boton para que usted pueda agendar sus clases prácticas.',
                                        icon: 'error',
                                        allowOutsideClick: false,
                                        showConfirmButton: false,
                                    });
