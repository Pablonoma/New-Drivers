...
<body>
    ...
    <section id="interface">
        ...
        <div class="values">
            <!-- Body Inicio  -->
            <br><br><br>
            <h1 class="heading">Calendario de clases prácticas (Clases Extras)</h1><br>
                ...
                <div class="modal-body" id="bod">
                    <form>
                        ...
                        <div class="form-group" style="margin-top:5px;">
                            ...
                            <textarea class="form-control" id="descripcionEdit" style="color: #000000;" rows="3" placeholder="Ingrese lo que desea aprender en esta clase extra"></textarea>
                        </div>
                        <div class="form-group" style="margin-top:5px;">
                            <div class="row">
                                <div class="col">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: {
                    url: 'Agendar-Controller/Controller_Calendario_Alumno.php?id=' + id_profesor + '&flag=agendarClaseExtra', // Pasa la variable como parámetro GET
                    method: 'GET',
            ...
            document.getElementById('eliminarEvento').addEventListener('click', function() {
                var observacion = document.getElementById('descripcionEdit').value;
                var id_solicitud = "<?php echo $varSolicitud ?>"; // Obtén el valor de la variable PHP
                let timerInterval;
                        Swal.fire({
                           title: 'Información!',
                           text: 'Al Agendar la clase extra, esta se mostrará en su calendario de clases prácticas.',
                           icon: 'warning',
                           timer: 4500,
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: 'Agendar-Controller/Controller_Calendario_Alumno.php?flag=agendarClaseExtra',
                            type: 'POST',
                            data: {
                                action: 'agendar',
