    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: {
                    url: 'Agendar-Controller/Controller_Calendario_Alumno.php?id=' + id_profesor + '&flag=agendarClasePractica', // Pasa la variable como parámetro GET
                    method: 'GET',
            ...
            document.getElementById('eliminarEvento').addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: 'Agendar-Controller/Controller_Calendario_Alumno.php?flag=agendarClasePractica',
                            type: 'POST',
                            data: {
                                action: 'agendar',
                            ...
                            success: function(response) {
                                if (response == 'success') {
                                    ...
                                    Swal.fire({
                                        title: 'Ya cuenta con todas sus clases prácticas agendadas',
                                        text: 'Ha alcanzado el máximo de 12 clases prácticas permitidas. Luego de completar sus clases prácticas, el profesor habilitará el boton para que usted pueda calificar el curso.',
                                        icon: 'error',
                                        allowOutsideClick: false,
                                        showConfirmButton: false,
                                    });
