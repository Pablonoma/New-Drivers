...
<body>
    ...
    <section id="menu">
        ...
        <div class="items">
            ...
            <a href="Clases-Alumno.php" style="color: #FDD45B;">
                <li><i class="fa-solid fa-book-open" style="color: #FDD45B;"></i>Clases Teóricas</li>
            </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: {
                    url: 'Agendar-Controller/Controller_Calendario_Alumno.php?flag=añadirObservacionTeorica',
                    method: 'GET',
